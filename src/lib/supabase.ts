...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://ujirzdzxlcejknkfbeom.supabase.co';
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVqaXJ6ZHp4bGNlamtua2ZiZW9tIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxMTExNzEsImV4cCI6MjA5NTY4NzE3MX0.YobRyxsN18W4YtzTrvefNI6EkuCCldE_3OouADzme5s';
...
// Get checklist items for an area and phase
...
// Get damage reports for session
